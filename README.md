...
# Awesome Stars [![Awesome](https://awesome.re/badge.svg)](https://github.com/yuceltoluyag/awesome)
...
- [Massu0921/kuvo-obs](https://github.com/Massu0921/kuvo-obs) - rekordbox KUVO の Live Playlist 機能を用いて OBS に再生中の曲を表示．Display playing rekordbox track infomation on OBS using KUVO's Live Playlist feature.
...
- [extratone/bilge](https://github.com/extratone/bilge) - Documentation for The Psalms - my blog about software’s intersection with culture. Not just for the website - for the entire process (correspondence, notetaking, drafting, _revising_, editorializing,
...
- [ikorihn/google-form-invitation](https://github.com/ikorihn/google-form-invitation) - Google Form からカレンダーイベントにゲスト招待を行う GAS
- [munky69rock/gas-google-form-notifier-to-slack](https://github.com/munky69rock/gas-google-form-notifier-to-slack) - Google Form の通知を GAS で Slack に通知する
...
- [soyalumno/aws_v4_signer_gas](https://github.com/soyalumno/aws_v4_signer_gas) - GAS から Amazon の SP-API を実行するための署名を作成する
